...
The current ABI supports deterministic modules, numeric imports and exports, direct C host callbacks, `i64`, Trit, register arithmetic, three-way Trit branches, internal calls, and instruction budgets. Host calls do not use JSON, string opcode dispatch, or stored process addresses.
