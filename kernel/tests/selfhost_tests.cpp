...
int main(int argc,char**argv){
    ...
    const Case logic_cases[]={{"thought logic() { true and not false }","logic",1,DAO_VALUE_TRIT},{"thought alternate() { false or true }","alternate",1,DAO_VALUE_TRIT},{"thought empty() { null }","empty",0,DAO_VALUE_NULL},{"thought nested_mutation() { matrix = [[1, 2], [3, 4]]; matrix[0][1] = 42; matrix[0][1] }","nested_mutation",42}};
