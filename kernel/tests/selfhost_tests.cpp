...
int main(int argc,char**argv){
    ...
    const auto run_rejections=[&](dao_module*compiler_module,dao_function compile_function){
        ...
        const std::string_view rejected[]={duplicate_parameter,register_overflow,bad_push_arity,bad_bind_target,bad_host_function_value,cyclic_module_import,missing_module_import,escaping_module_import};
