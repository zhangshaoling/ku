...
int main(int argc,char**argv){
    ...
    const Host hosts[]={{"source_len",1,source_len},{"source_byte",2,source_byte},{"source_slice",3,source_slice},{"source_hash",3,source_hash},{"builder_new",0,builder_new},{"builder_begin",3,builder_begin},{"builder_emit",6,builder_emit},{"builder_add_string",2,builder_add_string},{"builder_position",1,builder_position},{"builder_patch",3,builder_patch},{"builder_patch_marked",5,builder_patch_marked},{"builder_finish",2,builder_finish},{"builder_encode",1,builder_encode}};
